...
/* OTP AUTH */
.otp-step{animation:fadeUp .35s ease;}
.phone-input-wrap{display:flex;gap:8px;}
.country-code{background:var(--bg2);border:1px solid var(--bdr);border-radius:9px;padding:11px 12px;color:var(--gold);font-size:14px;font-weight:700;width:78px;text-align:center;outline:none;cursor:default;}
.otp-boxes{display:flex;gap:8px;justify-content:center;margin:8px 0 4px;}
.otp-digit{width:44px;height:54px;background:var(--bg2);border:2px solid var(--bdr);border-radius:10px;text-align:center;font-size:22px;font-weight:800;color:var(--txt);outline:none;transition:all .2s;font-family:'JetBrains Mono';}
.otp-digit:focus{border-color:var(--gold);box-shadow:0 0 0 3px rgba(245,158,11,.15);}
.otp-digit.filled{border-color:rgba(245,158,11,.4);}
.otp-resend{text-align:center;font-size:12px;color:var(--txt3);margin-top:12px;}
.otp-resend button{background:none;border:none;color:var(--gold);font-size:12px;font-weight:700;cursor:pointer;padding:0;}
.otp-resend button:disabled{color:var(--txt3);cursor:default;}
.auth-hint{font-size:11px;color:var(--txt3);text-align:center;margin-top:8px;line-height:1.6;}
.auth-back{background:none;border:none;color:var(--txt3);font-size:12px;font-weight:600;cursor:pointer;display:flex;align-items:center;gap:4px;margin-bottom:18px;padding:0;transition:color .2s;}
.auth-back:hover{color:var(--txt2);}
#recaptcha-container{margin:0 auto 12px;display:flex;justify-content:center;}
`;
